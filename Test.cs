...
public 		float	spin;											// Spin Direction
	...
	AnObject hourglass;									// Hourglass Information

	struct Timer		 											// Create A Structure For The Timer Information
	{
		public Int64       frequency;									// Timer Frequency
public 		float         resolution;									// Timer Resolution
public 		ulong mm_timer_start;								// Multimedia Timer Start Value
public 		ulong mm_timer_elapsed;							// Multimedia Timer Elapsed Time
public 		bool			performance_timer;							// Using The Performance Timer?
public 		Int64       performance_timer_start;					// Performance Timer Start Value
public 		Int64       performance_timer_elapsed;					// Performance Timer Elapsed Time
	};
    Timer timer;													// Structure Is Named timer
	...
	{
		Int64 time;											// time Will Hold A 64 Bit Integer
...
GL.CallLists(strlen(text),GL_UNSIGNED_BYTE, text);		// Write The Text To The Screen
    ...
    GL.oadIdentity();										// Reset The Modelview Matrix
	}
 ...
 *	fullscreenflag	- Use Fullscreen Mode (true) Or Windowed Mode (false)	*/
		...
		int			nCmdShow)						// Window Show State
	{
		...
		// TODO - Ask The User Which Screen Mode They Prefer
